...
namespace UnitTests
{
    ...
    public class DatabaseTests
    {
        ...
        public async Task CreateTestAsync()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                IDatabaseObject ms = (Organization)testItems.GetItem();
                IDatabaseObject msCreated = (Organization)await database.CreateAsync(ms);
                ms.iD = msCreated.iD;
                listToRemove.Add(ms);
        ...
        public async Task UpdateTestAsync()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                IDatabaseObject msUpdated = (Organization)testItems.GetItem();
                msUpdated.iD = ms.iD;
