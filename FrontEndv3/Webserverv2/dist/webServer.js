...
var WebServer = /** @class */ (function () {
    function WebServer(apiHandler) {
        ...
        this.app.get("/", function (req, response) { return __awaiter(_this, void 0, void 0, function () {
            var html, htmlReplacer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        html = fs_1.default.readFileSync('views/index.html', 'utf8');
                        apiHandler.refreshServiceDictionary();
                        htmlReplacer = "";
                        return [4 /*yield*/, apiHandler.getOrganizationList()
