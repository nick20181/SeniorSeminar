...
namespace Custodial.BoilerPlate.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class ServiceController<databaseObjectType> : IServiceController<databaseObjectType> where databaseObjectType : IDatabaseObject
    {
        ...
        public ServiceController()
        {
            ...
            {
                database = new InMemoryDatabase<databaseObjectType>();
            }
