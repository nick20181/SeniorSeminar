...
namespace UnitTests
{
    ...
    class DatabaseObjectTests
    {
        ...
        public DatabaseObjectTests()
        {
            ...
            {
                database = new MongoDatabase<IDatabaseObject>(settings.databaseSettings);
            }
            else
            {
        ...
        public void ToJsonTest()
        {
            ...
            IDatabaseObject microservice = default;
            ...
            IDatabaseObject testService = JsonConvert.DeserializeObject<IDatabaseObject>(testCase);
